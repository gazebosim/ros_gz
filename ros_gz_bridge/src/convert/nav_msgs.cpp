  ...
  ignition::msgs::Odometry & gz_msg)
{
  ...
  convert_ros_to_ign(ros_msg.pose.pose, (*gz_msg.mutable_pose()));
  convert_ros_to_ign(ros_msg.twist.twist, (*gz_msg.mutable_twist()));
...
{
  convert_ros_to_ign(ros_msg.header, (*gz_msg.mutable_header()));
  convert_ros_to_ign(ros_msg.pose, (*gz_msg.mutable_pose_with_covariance()));
  convert_ros_to_ign(ros_msg.twist, (*gz_msg.mutable_twist_with_covariance()));
