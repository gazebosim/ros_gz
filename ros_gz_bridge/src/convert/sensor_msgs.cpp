  ...
  ignition::msgs::IMU & gz_msg)
{
  ...
  convert_ros_to_ign(ros_msg.angular_velocity, (*gz_msg.mutable_angular_velocity()));
  convert_ros_to_ign(ros_msg.linear_acceleration, (*gz_msg.mutable_linear_acceleration()));
}
...
{
  convert_ros_to_ign(ros_msg.header, (*gz_msg.mutable_header()));
  convert_ros_to_ign(ros_msg.magnetic_field, (*gz_msg.mutable_field_tesla()));
}
