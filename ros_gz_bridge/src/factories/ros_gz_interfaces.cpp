  ...
  const std::string & ign_type_name)
{
    ...
    ign_type_name == "ignition.msgs.JointWrench")
  {
    return std::make_shared<
      ...
      >
    >("ros_gz_interfaces/msg/JointWrench", ign_type_name);
  }
  if (
    ...
    ign_type_name == "ignition.msgs.Entity")
  {
    return std::make_shared<
      ...
      >
    >("ros_gz_interfaces/msg/Entity", ign_type_name);
  }
  if (
    ...
    ign_type_name == "ignition.msgs.Contact")
  {
    return std::make_shared<
      ...
      >
    >("ros_gz_interfaces/msg/Contact", ign_type_name);
  }
  if (
    ...
    ign_type_name == "ignition.msgs.Contacts")
  {
    return std::make_shared<
      ...
      >
    >("ros_gz_interfaces/msg/Contacts", ign_type_name);
  }
    ...
    ros_type_name.empty()) && ign_type_name == "ignition.msgs.GUICamera")
  {
    return std::make_shared<
      ...
      >
    >("ros_gz_interfaces/msg/GuiCamera", ign_type_name);
  }
    ...
    ros_type_name.empty()) && ign_type_name == "ignition.msgs.Light")
  {
    return std::make_shared<
      Factory<
        ...
        ignition::msgs::Light
      >
    >("ros_gz_interfaces/msg/Light", ign_type_name);
  }
    ...
    ros_type_name.empty()) && ign_type_name == "ignition.msgs.StringMsg_V")
  {
    return std::make_shared<
      ...
      >
    >("ros_gz_interfaces/msg/StringVec", ign_type_name);
  }
    ...
    ros_type_name.empty()) && ign_type_name == "ignition.msgs.TrackVisual")
  {
    return std::make_shared<
      ...
      >
    >("ros_gz_interfaces/msg/TrackVisual", ign_type_name);
  }
    ...
    ros_type_name.empty()) && ign_type_name == "ignition.msgs.VideoRecord")
  {
    return std::make_shared<
      ...
      >
    >("ros_gz_interfaces/msg/VideoRecord", ign_type_name);
  }
    ...
    ros_type_name.empty()) && ign_type_name == "ignition.msgs.WorldControl")
  {
    return std::make_shared<
      ...
      >
    >("ros_gz_interfaces/msg/WorldControl", ign_type_name);
  }
  return nullptr;
}
