...
{
  if (
    (ros_type_name == "ros_gz_interfaces/msg/JointWrench" || ros_type_name.empty()) &&
    gz_type_name == "ignition.msgs.JointWrench")
  {
    return std::make_shared<
      ...
      >
    >("ros_gz_interfaces/msg/JointWrench", gz_type_name);
  }
  if (
    (ros_type_name == "ros_gz_interfaces/msg/Entity" || ros_type_name.empty()) &&
    gz_type_name == "ignition.msgs.Entity")
  {
    return std::make_shared<
      ...
      >
    >("ros_gz_interfaces/msg/Entity", gz_type_name);
  }
  if (
    (ros_type_name == "ros_gz_interfaces/msg/Contact" || ros_type_name.empty()) &&
    gz_type_name == "ignition.msgs.Contact")
  {
    return std::make_shared<
      ...
      >
    >("ros_gz_interfaces/msg/Contact", gz_type_name);
  }
  if (
    (ros_type_name == "ros_gz_interfaces/msg/Contacts" || ros_type_name.empty()) &&
    gz_type_name == "ignition.msgs.Contacts")
  {
    return std::make_shared<
      ...
      >
    >("ros_gz_interfaces/msg/Contacts", gz_type_name);
  }
  if ((ros_type_name == "ros_gz_interfaces/msg/GuiCamera" ||
    ros_type_name.empty()) && gz_type_name == "ignition.msgs.GUICamera")
  {
    return std::make_shared<
      Factory<
      ...
      >
    >("ros_gz_interfaces/msg/GuiCamera", gz_type_name);
  }
  if ((ros_type_name == "ros_gz_interfaces/msg/Light" ||
    ros_type_name.empty()) && gz_type_name == "ignition.msgs.Light")
  {
    return std::make_shared<
      Factory<
        ...
        ignition::msgs::Light
      >
    >("ros_gz_interfaces/msg/Light", gz_type_name);
  }
  if ((ros_type_name == "ros_gz_interfaces/msg/StringVec" ||
    ros_type_name.empty()) && gz_type_name == "ignition.msgs.StringMsg_V")
  {
    return std::make_shared<
      Factory<
      ...
      >
    >("ros_gz_interfaces/msg/StringVec", gz_type_name);
  }
  if ((ros_type_name == "ros_gz_interfaces/msg/TrackVisual" ||
    ros_type_name.empty()) && gz_type_name == "ignition.msgs.TrackVisual")
  {
    return std::make_shared<
      Factory<
      ...
      >
    >("ros_gz_interfaces/msg/TrackVisual", gz_type_name);
  }
  if ((ros_type_name == "ros_gz_interfaces/msg/VideoRecord" ||
    ros_type_name.empty()) && gz_type_name == "ignition.msgs.VideoRecord")
  {
    return std::make_shared<
      Factory<
      ...
      >
    >("ros_gz_interfaces/msg/VideoRecord", gz_type_name);
  }
  if ((ros_type_name == "ros_gz_interfaces/msg/WorldControl" ||
    ros_type_name.empty()) && gz_type_name == "ignition.msgs.WorldControl")
  {
    return std::make_shared<
      Factory<
      ...
      >
    >("ros_gz_interfaces/msg/WorldControl", gz_type_name);
  }
  return nullptr;
}
