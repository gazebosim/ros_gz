...
public:
  ...
  /// \param[in] gz_topic_name Name of the GZ Topic
  /// \param[in,out] gz_type_name Name of the GZ Msg type
  ...
  /// \param[in] ros_topic_name Name of the ROS Topic
  /// \param[in,out] ros_type_name Name of the ROS Msg type
  /// \return True if resolved successfully, false otherwise
  ...
  /// \return True if resolved successfully, false otherwise
  bool resolve_bridge_types(BridgeConfig & config);
