...
class GzSpawnModel(Action):
    ...
    def __init__(
        ...
        *,
        ...
        sdf_string: Optional[SomeSubstitutionsType] = None,
    ...
    def parse(cls, entity: Entity, parser: Parser):
        ...
        if isinstance(sdf_string, str):
            sdf_string = parser.parse_substitution(sdf_string)
            kwargs['sdf_string'] = sdf_string
